...
namespace suxiang
{
    public abstract class DbHelper
    {
            ...
            DataSet dataSet, string tableName)
        {
            ...
            using (var dataAdapter = CreateDataAdapter(null,
        ...
        {
            var type = Type.GetType("SSML.DAL.SqlServer", true, true);
        ...
        ///     An array of DbParameters to be associated with the command or 'null' if no parameters
        ///     are required
        /// </param>
        ...
        /// <remarks>
        ///     e.g.:
        ///     int result = ExecuteNonQuery(conn, CommandType.StoredProcedure, "PublishOrders", new IDbDataParameter("@prodid",
        ///     24));
        /// </remarks>
        /// <param name="connection">A valid IDbConnection</param>
        /// <param name="commandType">The CommandType (stored procedure, text, etc.)</param>
        ...
        /// <remarks>
        ///     e.g.:
        ///     DataSet ds = ExecuteDataset(connString, CommandType.StoredProcedure, "GetOrders", new IDbDataParameter("@prodid",
        ///     24));
        /// </remarks>
        /// <param name="connectionString">A valid connection string for a IDbConnection</param>
        /// <param name="commandType">The CommandType (stored procedure, text, etc.)</param>
            ...
            params IDbDataParameter[] commandParameters)
        {
            ...
            var cmd = CreateCommand();
            var mustCloseConnection = false;
            cmd.CommandTimeout = 1000; //请求超时设为10秒
            PrepareCommand(cmd, connection, null, commandType, commandText, commandParameters, out mustCloseConnection);
        ...
        /// <remarks>
        ///     e.g.:
        ///     IDataReader dr = ExecuteReader(connString, CommandType.StoredProcedure, "GetOrders", new
        ///     IDbDataParameter("@prodid", 24));
        /// </remarks>
        /// <param name="connectionString">A valid connection string for a IDbConnection</param>
        /// <param name="commandType">The CommandType (stored procedure, text, etc.)</param>
        ...
        /// <remarks>
        ///     e.g.:
        ///     IDataReader dr = ExecuteReader(conn, CommandType.StoredProcedure, "GetOrders", new IDbDataParameter("@prodid",
        ///     24));
        /// </remarks>
        /// <param name="connection">A valid IDbConnection</param>
        /// <param name="commandType">The CommandType (stored procedure, text, etc.)</param>
        ...
        /// <remarks>
        ///     e.g.:
        ///     IDataReader dr = ExecuteReader(trans, CommandType.StoredProcedure, "GetOrders", new IDbDataParameter("@prodid",
        ///     24));
        /// </remarks>
        /// <param name="transaction">A valid IDbTransaction</param>
        /// <param name="commandType">The CommandType (stored procedure, text, etc.)</param>
        ...
        /// <summary>
        ///     Private helper method that execute a IDbCommand (that returns a resultset) against the specified IDbTransaction and
        ///     IDbConnection
        ///     using the provided parameters.
        /// </summary>
        /// <remarks>
        ...
        ///     创建IDbDataParameter的实例
        /// </summary>
        public IDbDataParameter CreateDbParameter(string parameterName, DbType dbType, object value)
        {
            var param = CreateDbParameter(parameterName);
            param.DbType = dbType;
        ...
        ///     创建IDbDataParameter的实例
        /// </summary>
        public IDbDataParameter CreateDbParameter(string parameterName, DbType dbType, int size,
