<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="QualityQuestionForm.aspx.cs" Inherits="suxiang.Form.QualityQuestionForm" %>
                    ...
                    if ($("#projectid").val() != -1 && $("#buildingno").val() != '') {
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                if (json.State === true) {
                                    window.open("QualityQuestion.aspx", "_self");
                                }
                            },
                            error: function (data) {
                                var json = JSON.parse(data);
