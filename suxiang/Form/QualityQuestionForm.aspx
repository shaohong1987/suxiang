...
CodeBehind="QualityQuestionForm.aspx.cs" Inherits="suxiang.Form.QualityQuestionForm" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $(".placeul").html("<li><a href='NewForm.aspx'>各类表单</a></li><li><a>质量问题表</a></li>");
            $(".select1").uedSelect({
                width: 345
            });
            $(".select2").uedSelect({
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.each(d,
                        function(i, item) {
                            $("#teamleader").append("<option value='" +
                                item['Id'] +
                                "-" +
                                item["realname"] +
                                "'>" +
            ...
            <ul class="forminfo">
                ...
                <li>
                    ...
                    <input type="text" name="worktimecost_xb" placeholder="整改花费工时（数字）" class="dfinput"
                           onkeyup="this.value = this.value.replace(/[^0-9.]/g, '')" style="margin-left: 6px; margin-right: 3px; width: 140px;"/>小工
                </li>
                <li>
                    <label>
                        耗费材料<b></b>
