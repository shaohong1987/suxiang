<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MaterialAuxiliaryCostForm_ReComfirm.aspx.cs" Inherits="suxiang.Form.MaterialAuxiliaryCostForm_ReComfirm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="usual1" class="usual">
        <ul class="forminfo">
            ...
            <li>
                <label>班组长备注</label>
                <textarea class="textinput2" id="comfirmremark" placeholder="班组长备注"></textarea>
            </li>
            <li>
                <label>栋号长备注</label>
                <textarea class="textinput2" id="recomfirmremark" placeholder="栋号长备注"></textarea>
            </li>
            <li>
