<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LaborCostForm_View.aspx.cs" Inherits="suxiang.Form.LaborCostForm_View" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        $(document)
            .ready(function() {
                $(".placeul").html("<li><a href='Complete.aspx'>已处理</a></li><li><a>用工成本表</a></li>");
