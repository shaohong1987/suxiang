<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MaterialAuxiliaryCostForm_Summary.aspx.cs" Inherits="suxiang.Form.MaterialAuxiliaryCostForm_Summary" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $.ajax({
                type: "POST",
                url: "../Handler/Process.ashx?action=getdata&type=cost_materialauxiliary&formid=1",
                cache: false,
   ...
   <input type="hidden" id="formId" value="-1"/>
    ...
    <div id="usual1" class="usual">
        <ul class="forminfo">
            ...
            <a href="MaterialCostForm.aspx">MaterialCostForm.aspx</a>
            <li>
                <label>
                    日期<b>*</b>
                </label>
