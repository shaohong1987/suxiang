<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="SecurityQuestionForm_Team.aspx.cs" Inherits="suxiang.Form.SecurityQuestionForm_Team" %>
        ...
        <ul class="forminfo">
            ...
            <li>
                ...
                <input type="text" id="worktimecost_db" placeholder="整改花费工时（数字）" class="dfinput"
                    style="width: 140px; margin-right: 3px;" />大工
            ...
            <li>
                ...
                <textarea class="textinput3" id="materialcost" placeholder="整改耗费材料"></textarea>
            </li>
            <li>
                <button type="button" class="btn" onclick="doUpdateWM();">
                    确认保存
                </button>
            </li>
        </ul>
