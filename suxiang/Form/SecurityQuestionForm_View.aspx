<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="SecurityQuestionForm_View.aspx.cs" Inherits="suxiang.Form.SecurityQuestionForm_View" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        $(document)
            .ready(function() {
                $(".placeul").html("<li><a  href='Complete.aspx'>已处理</a></li><li><a>安全问题表</a></li>");
                $(".select3").uedSelect({
                    width: 80
                });
        ...
        <ul class="forminfo">
           ...
           <li>
                ...
                <div style="float: left; margin-left: 5px;">
                   <input type="text" id="levelno" placeholder="安全等级" class="dfinput" style="width: 80px" readonly="readonly"/>
                </div>
            </li>
            <li>
                <label>
