	...
	return this.each( function() {
		...
		setPager = function (pgid, tp){
			...
			if(ts.p.pgbuttons===true) {
				...
				//pgl += "<td id='" + po[0] + "' class='ui-pg-button ui-corner-all'><span>首页</span></td>";
				//pgl += "<td id='" + po[1] + "' class='ui-pg-button ui-corner-all'><span>上一页</span></td>";
				//pgl += pginp !== "" ? sep + pginp + sep : "";
				//pgl += "<td id='" + po[2] + "' class='ui-pg-button ui-corner-all'><span>下一页</span></td>";
				//pgl += "<td id='" + po[3] + "' class='ui-pg-button ui-corner-all'><span>末页</span></td>";
