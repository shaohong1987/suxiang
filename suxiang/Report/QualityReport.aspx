<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="QualityReport.aspx.cs" Inherits="suxiang.Report.QualityReport" %>
        ...
        "json");
            ...
            $("#BtnSearch").on("click",function() {
                        jQuery("#jqGrid")
                            .jqGrid('setGridParam',
                            {
                                url: "../Handler/Process.ashx?action=GetQualityProblems",
                                postData: {
