<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MaterialAuxiliaryCostReport.aspx.cs" Inherits="suxiang.Report.MaterialAuxiliaryCostReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
        ...
        "json");
            ...
            $("#BtnSearch").on("click", function () {
                jQuery("#jqGrid")
                            .jqGrid('setGridParam',
                            {
                                url: "../Handler/Process.ashx?action=GetMaterialAuxiliaryCost",
                                postData: {
  ...
  function () {
      window.location
          .href = "../Handler/Process.ashx?action=ExportProjects&projectId=" + $("#project").val() + "&month=" + $("#fmonth").val() + "&type=cost_materialauxiliary";
  });
