<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QualityReport.aspx.cs"
    Inherits="suxiang.mobile.Report.QualityReport" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function doPost() {
            ...
            $.post("../Handler/Process.ashx", { action: "GetQualityProblems", pid: projectid, sdate: startdate, edate: enddate }, function (data) {
                var json = eval(data);
                $("table tbody").html('');
                if (json.length == 0) {
