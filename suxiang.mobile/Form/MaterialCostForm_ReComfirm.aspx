<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MaterialCostForm_ReComfirm.aspx.cs" Inherits="suxiang.mobile.Form.MaterialCostForm_ReComfirm" %>
            ...
            <form id="materialcostForm" method="POST">
                <div data-role="fieldcontain">
                   ...
                   <input type="hidden" value="-1" id="ids" />
                    ...
                    <textarea cols="40" rows="8" id="recomfirmremark" name="recomfirmremark" placeholder="栋号长备注"></textarea>
