<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SecurityQuestionForm_Team.aspx.cs" Inherits="suxiang.mobile.Form.SecurityQuestionForm_Team" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function doUpdateWM() {
            var db = $("#worktimecost_db").val();
            var xb = $("#worktimecost_xb").val();
            ...
            <form id="sqform"> 
                <div data-role="fieldcontain">
                   ...
                   <input type="text" name='responsibleperson2' id="responsibleperson2" readonly="readonly"/>  
                    ...
                    <input type="text" name='worktimecost_db' id="worktimecost_db"/>
                    <label for="worktimecost_xb">耗费工时（小工）：</label>
                    <input type="text" name='worktimecost_xb' id="worktimecost_xb"/>
                    <label for="materialcost">耗费材料：</label>
                    <input type="text" name='materialcost' id="materialcost"/>
                    <img  id="pic" width="98%"/>
                    <h3 id="notification"></h3>
                    <button data-theme="b" type="button" onclick="doUpdateWM();">确认提交</button>
                </div>
            </form>
        </div>
    </div>
