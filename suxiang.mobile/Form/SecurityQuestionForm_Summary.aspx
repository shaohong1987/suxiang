<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SecurityQuestionForm_Summary.aspx.cs" Inherits="suxiang.mobile.Form.SecurityQuestionForm_Summary" %>
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $("#levelno").selectmenu("refresh", true);
