<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MaterialCostForm_Update.aspx.cs" Inherits="suxiang.mobile.Form.MaterialCostForm_Update" %>
            ...
            <form id="mcform" method="POST">
                <div data-role="fieldcontain">
                   <input type="hidden" id="formId" value="-1" name="formId"/>
                    ...
                    <input type="hidden" value="doMaterialCostUpdate" name="action" />
                    ...
                    <textarea cols="40" rows="18" id="comfirmremark" name="comfirmremark" placeholder="班组备注" readonly="readonly"></textarea>
