...
<head>
    ...
    <script type="text/javascript">
        ...
        function doPost() {
            if ($("#projectname").val() == '' || $("#projectname").val() == '' || $("#buildingno").val() == '' || $("#buildingno").val() == '-1' || $("#curdate").val() == '' || $("#workteam").val() == ''
            ...
            var formData = $("#materialcostForm").serialize();
            $.ajax({
                type: "POST",
                url: "../Handler/process.ashx?action=MaterialCostForm",
                cache: false,
                data: formData,
        ...
        <div>
            <form id="materialcostForm" method="POST">
                <div data-role="fieldcontain">
                    ...
                    <label for="workteam">班组：</label>
                    <input type="text" name='workteam' id='workteam' placeholder="班组" />
                    <label for="content">材料名称：</label>
                    <input type="text" name='content' id='content' placeholder="名称" />
