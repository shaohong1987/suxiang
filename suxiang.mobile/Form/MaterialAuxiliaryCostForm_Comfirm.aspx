<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MaterialAuxiliaryCostForm_Comfirm.aspx.cs" Inherits="suxiang.mobile.Form.MaterialAuxiliaryCostForm_Comfirm" %>
        ...
        <div>
            <form id="materialcostForm" method="POST">
                <div data-role="fieldcontain">
                    ...
                    <input type="text" name="addr" id="addr" placeholder="地点" readonly="readonly"/>
                    ...
                    <input type="text" name='materialname' id='materialname' placeholder="名称" readonly="readonly" />
