<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QualityQuestionForm_View.aspx.cs" Inherits="suxiang.mobile.Form.QualityQuestionForm_View" %>
            ...
            <form id="securityform">
                <div data-role="fieldcontain">
                   ...
                   <input type="text" name='responsibleperson2' id="responsibleperson2" readonly="readonly"/>  
                    ...
                    <textarea cols="40" rows="18" id="summary" name="summary" readonly="readonly"></textarea>
                </div>
            </form>
        </div>
    </div>
