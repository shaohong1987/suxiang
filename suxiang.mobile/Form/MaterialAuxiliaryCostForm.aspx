<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MaterialAuxiliaryCostForm.aspx.cs" Inherits="suxiang.mobile.Form.MaterialAuxiliaryCostForm" %>
                    ...
                    if ($("#projectid").val() != -1 && $("#buildingno").val() != '') {
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
	                            ...
	                            alert(json.Msg);
                                if (json.State === true) {
                                    window.open("MaterialAuxiliaryCostForm.aspx", "_self");
                                }
                            },
                            error: function (data) {
                                var json = JSON.parse(data);
    ...
    <div>
        ...
        <div>
            <form id="mcform" method="POST">
                <input type="hidden" value="MaterialAuxiliaryCostForm" name="action" />
                <div data-role="fieldcontain">
                    ...
                    <label for="materialname">辅材名称：</label>
                    <input type="text" name='materialname' id='materialname' placeholder="辅材名称" />
                    ...
                    <textarea cols="40" rows="8" id="remarkbyworker" name="remarkbyworker" placeholder="备注"></textarea>
