<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LaborCostForm_Remark.aspx.cs" Inherits="suxiang.mobile.Form.LaborCostForm_Remark" %>
        ...
        <div data-role="content">
            <form id="laborcostForm">
                <div data-role="fieldcontain">
                    ...
                    <input type="text" id="teamleader" placeholder="班组" readonly="readonly" readonly="readonly"/>       
