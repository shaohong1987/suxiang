<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LaborCostForm_ReComfirm.aspx.cs" Inherits="suxiang.mobile.Form.LaborCostForm_ReComfirm" %>
        ...
        <div data-role="content">
            <form id="laborcostForm">
                <div data-role="fieldcontain">
                    ...
                    <input type="text" name='enddate' id="endate" readonly="readonly"/>
                    <label for="worktype">工种：</label> 
                    <input type="text" name='worktype' id='worktype' readonly="readonly"/>
                    ...
                    <input type="text" name='workcontent' id='workcontent' readonly="readonly"/>
